...
<head>
	...
	<title>Pricing Tables - Everest Responsive Multipurpose Template</title>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="page_title">
                            ...
                            <span class="sub_heading">Pricing Tables layout</span>
                        </div>
                        <nav id="breadcrumbs">
                            <ul>
                                <li>You are here:</li>
            ...
            <div class="row">
                <div class="col-sm-9">
                    <div class="promo_content">
                        <h3>Everest is awesome responsive template, with clean design.</h3>
