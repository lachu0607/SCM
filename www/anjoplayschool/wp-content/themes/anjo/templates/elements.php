...
<head>
	...
	<title>Everest Responsive Multipurpose Template</title>
    ...
    <header id="header">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-3">
                    <div id="logo">
                        <h1><a href="index.html"><img src="images/logo.png" alt="Everest"/></a></h1>
                    </div>
                </div>
                        ...
                        <div class="promo_box">
                            <div class="col-lg-9 col-sm-9">
                                <div class="promo_content">
                                    <h3>Everest is awesome responsive template, with refreshingly clean design.</h3>
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" data-parent="#accordion" href="#collapse1">
                                            ...
                                            Lorem ipsum dolor Sit amet for ever
                                            <span class="accordion-icon"><i class="switch fa fa-plus-circle"></i></span>
                                        </a>
                                    </h4>
                                </div>
